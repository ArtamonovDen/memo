...
import (
	...
	"github.com/ArtamonovDen/memo/apperrors"
	"github.com/ArtamonovDen/memo/model"
	"github.com/ArtamonovDen/memo/model/mocks"
...
func TestMe(t *testing.T) {
	...
	t.Run("Success", func(t *testing.T) {
		...
		// TODO: why do we do it right here in test?

		NewAccountHandler(&RouteConfig{
			R:           router,
